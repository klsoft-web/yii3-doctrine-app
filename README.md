...
The template includes a  [Yii 3 authentication](https://yiisoft.github.io/docs/guide/security/authentication.html) implementation using the [yiisoft/user](https://github.com/yiisoft/user) package for demo purposes. You can replace or remove this package as needed.
...
## How to use with Docker
 ...
 4. Create the database schema:
    ```bash 
    docker compose exec app ./yii doctrine:orm:schema-tool:create
    ```
